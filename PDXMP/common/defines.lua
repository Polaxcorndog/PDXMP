...
country = {
	...
	UNCIV_TECH_SPREAD_MAX = 0.20, --Max techs an unciv will get on westernizing
...
economy = {
	...
	LOAN_BASE_INTEREST			= 0.03,
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 10,
	BANKRUPTCY_FACTOR = 0.2,
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 2000,
	MAX_LOAN_CAP_FROM_BANKS = 30, -- can loan max % of country tax base from single country
	...
	FACTORY_UPGRADE_EMPLOYEE_FACTOR = 0.85, -- determines how close to the employee limit we need to be before "upgrade all" will upgrade/expand a given factory (1 = 100%).
...
military = {
	...
	LEADER_MAX_RANDOM_PRESTIGE = 0.12, -- max percent of prestige, when randomizing stats for leaders.
	LEADER_AGE_DEATH_FACTOR = 5, -- higher value means leaders live longer
	LEADER_PRESTIGE_TO_MORALE_FACTOR = 0.10, -- f.ex. 100% of prestige = +10% morale
	LEADER_PRESTIGE_TO_MAX_ORG_FACTOR = 0.05, -- f.ex. 100% of prestige = +10 max org
	...
	SIEGE_BRIGADES_BONUS = 0.6, -- the bonus to siege speed from each brigade
...
diplomacy = {
	...
	GOODRELATION_PRESTIGE_RELEASE_PUPPET = -10,
	GOODRELATION_PRESTIGE_MAKE_PUPPET = -10,
	GOODRELATION_PRESTIGE_DISARMAMENT = -10,
	GOODRELATION_PRESTIGE_DESTROY_FORTS = -10,
	GOODRELATION_PRESTIGE_DESTROY_NAVAL_BASES = -10,
	GOODRELATION_PRESTIGE_REPARATIONS = -10,
	GOODRELATION_PRESTIGE_TRANSFER_PROVINCES = -10,
	GOODRELATION_PRESTIGE_REMOVE_CORES = 0,
	GOODRELATION_PRESTIGE_PRESTIGE = -10,
	GOODRELATION_PRESTIGE_CONCEDE = -10,
	GOODRELATION_PRESTIGE_STATUS_QUO = -10,
	GOODRELATION_PRESTIGE_ANNEX = -10,
	GOODRELATION_PRESTIGE_DEMAND_STATE = -10,
	GOODRELATION_PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE = -10,
	GOODRELATION_PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE = -10,
	GOODRELATION_PRESTIGE_COLONY = -10,
	
	GOODRELATION_MILITANCY_ADD_TO_SPHERE = 1,
	GOODRELATION_MILITANCY_RELEASE_PUPPET = 1,
	GOODRELATION_MILITANCY_MAKE_PUPPET = 1,
	GOODRELATION_MILITANCY_DISARMAMENT = 1,
	GOODRELATION_MILITANCY_DESTROY_FORTS = 1,
	GOODRELATION_MILITANCY_DESTROY_NAVAL_BASES = 1,
	GOODRELATION_MILITANCY_REPARATIONS = 1,
	GOODRELATION_MILITANCY_TRANSFER_PROVINCES = 1,
	GOODRELATION_MILITANCY_REMOVE_CORES = 0,
	GOODRELATION_MILITANCY_PRESTIGE = 1,
	GOODRELATION_MILITANCY_CONCEDE = 1,
	GOODRELATION_MILITANCY_STATUS_QUO = 1,
	GOODRELATION_MILITANCY_ANNEX = 1,
	GOODRELATION_MILITANCY_DEMAND_STATE = 1,
	GOODRELATION_MILITANCY_INSTALL_COMMUNIST_GOV_TYPE = 1,
	GOODRELATION_MILITANCY_UNINSTALL_COMMUNIST_GOV_TYPE = 1,
	GOODRELATION_MILITANCY_COLONY = 1,
...
ai =
{
	...
	SOLDIER_FRACTION = 0.040, -- max amount of population AI wants to be soldiers
...
graphics =
{
	...
	CITIES_SIZE_MAX_POPULATION_K = 1500 			-- When province population reach 1mln, the city will get it's maximum size.
}
